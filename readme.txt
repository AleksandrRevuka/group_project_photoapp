...
Застосунок розроблено відповідно до технічного завдання компанії GoIT "Технічне завдання на створення застосунку “PhotoShare” (REST API)".
Застосунок являється екзаменаційною роботою з курсу "Python Web", ставить завданням закріплення отриманих під час навчання знань та
відпрацювання командної роботи і роботи з GitHub.

2. Доступ до застосунку
Python-скрипт застосунку доступний в репозиторії https://github.com/AleksandrRevuka/group_project_photoapp/tree/develop.
Розгортання (deploy) застосунку виконано по адресу http://http://api.photoa.pp.ua:8000/docs#/.
...
Застосунок реалізований на фреймворку FastAPI. В якості бази даних використано PostgreSQL.
Для взаємодії з базою даних, використано бібліотеку SQLAlchemy.
...
Функціональність: реєстрація юзера. Під час першої реєстрації юзер автоматично позначається як Адміністратор.
Під час реєстрації виконується підтвердження електронної пошти через надісланий лист.
Приклад результату роботи:
{
  "user": {
    ...
    "avatar": "https://www.gravatar.com/avatar/b24e2a8c0c6bb989a9c4dccb52f94",
    "roles": "user"
  },
...
Приклад результату роботи:
{
  "id": 1,
  "username": "Yevhen",
  "email": "fastapi_kulyk@meta.ua",
  "avatar": "https://www.gravatar.com/avatar/b24e2a8c0c6bb989a9c4dccb52f94263",
  "roles": "user"
}
...
Приклад результату роботи:
{
  ...
  "pictures_count": 0,
  "comments_count": 0,
  "created_at": "2023-10-21T16:56:24.012Z",
  "updated_at": "2023-10-21T16:56:24.012Z"
}
6.2.5. "Ban User":
Параметри, що приймає endpoint: "username": "string".
...
[
  {
    "id": 0,
    "tagname": "string",
    "created_at": "2023-10-21T17:27:35.109Z",
    "updated_at": "2023-10-21T17:27:35.109Z"
  }
]
6.4.2. "Gat Tag":
...
Приклад результату роботи:
{
  "id": 0,
  "tagname": "string",
  "created_at": "2023-10-21T17:28:49.784Z",
  "updated_at": "2023-10-21T17:28:49.784Z"
}
6.4.3. "Update Tag":
Параметри, що приймає endpoint: "tag_id": "integer".
...
Приклад результату роботи:
{
  "id": 0,
  "tagname": "string",
  "created_at": "2023-10-21T17:30:19.670Z",
  "updated_at": "2023-10-21T17:30:19.670Z"
}
6.4.4. "Delete Tag":
Параметри, що приймає endpoint: "tag_id": "integer".
...
[
  {
    "id": 0,
    "tagname": "string",
    "created_at": "2023-10-21T17:34:15.139Z",
    "updated_at": "2023-10-21T17:34:15.139Z"
  }
]
----------------
6.5. "pictures":
6.5.1. "Upload Picture To Cloudinary":
Параметри, що приймає endpoint: "name": "string", "description": "string", "width": "integer",
"height": "integer", "crop": "string", "gravity": "string", "angle": "integer", file.
...
Функціональність: пошук коритувача по імені/частині імені.
Приклад результату роботи:
[
  {
    "username": "string",
