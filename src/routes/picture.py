...
from src.schemas.picture import PictureUpload, PictureResponse
...
async def upload_picture_to_cloudinary(
    ...
    picture_datas = await repository_photos.save_data_of_picture_to_db(body, picture_url, db)
    return {'picture': picture_datas, "detail": "hbhxcjndjvnfjvnfjn."}
